...
?>
    <section class="edit-comment">
        ...
        <form action="" method="post">
            ...
            <textarea name="update_box" class="box" maxlength="1000" required placeholder="masukan komentar" cols="30"
                rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
            <div class="flex">
                <a href="comments.php" class="inline-option-btn">Batal edit</a>
...
?>
    ...
    <section class="comments">
        ...
        <h1 class="heading">Riwayat komentar</h1>
            ...
            <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
                <div class="content"><span><?= $fetch_comment['date']; ?></span>
                    <p> - <?= $fetch_content['title']; ?> - </p><a
                        href="watch_video.php?get_id=<?= $fetch_content['id']; ?>">Lihat konten</a>
                </div>
         ...
         ?>
                <form action="" method="post" class="flex-btn">
                    ...
                    <button type="submit" name="delete_comment" class="inline-delete-btn"
                        onclick="return confirm('hapus komentar?');">Hapus komentar</button>
                </form>
                <?php
         }
         ?>
