                ...
                <form action="" method="post" class="save-list">
                  ...
                  ?>
                    <button type="submit" name="save_list"><i
                            class="fas fa-bookmark"></i><span>Tersimpan</span></button>
                    <?php
                  } else {
                  ?>
                    <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>Simpan
    ...
    <section class="videos-container">
        ...
        <div class="box-container">
         ...
         ?>
            ...
            echo '<p class="empty">Tidak ada playlist yang tersedia!</p>';
         }
         ?>
