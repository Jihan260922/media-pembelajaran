...
if (isset($_POST['update'])) {
   ...
   $update_content = $conn->prepare("UPDATE `content` SET title = ?, description = ?, status = ?, playlist_id = ?, class = ? WHERE id = ?");
   $update_content->execute([$title, $description, $status, $playlist, $class, $video_id]);
    ...
    <section class="video-form">
      ...
      ?>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <p>Update Kelas<span>*</span></p>
            <select name="class" class="box" required>
                <option value="<?= $fecth_videos['class']; ?>" selected><?= $fecth_videos['class']; ?></option>
            ...
            <textarea name="description" class="box" required placeholder="masukan deskripsi" maxlength="1000" cols="30"
            ...
            <select name="playlist" class="box">
                ...
                <?php
                     ...
                     echo '<option value="" disabled>Tidak ada playlist yang ditambhakan!</option>';
                  }
                  ?>
            </select>
            <img src="../uploaded_files/<?= $fecth_videos['thumb']; ?>" alt="">
            <p>Update foto sampul</p>
            <input type="file" name="thumb" accept="image/*" class="box">
            <video src="../uploaded_files/<?= $fecth_videos['video']; ?>" controls></video>
            <p>Update video</p>
            <input type="file" name="video" accept="video/*" class="box">
            <input type="submit" value="update konten" name="update" class="btn">
            <div class="flex-btn">
        ...
        <?php
         ...
         echo '<p class="empty">video not found! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Tambah video</a></p>';
      }
      ?>
