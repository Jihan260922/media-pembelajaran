        ...
        <div class="row">
            ...
            <div class="details">
                ...
                <form action="" method="post" class="flex-btn">
                    ...
                    <input type="submit" value="hapus playlist" class="delete-btn"
    ...
    <section class="contents">
        ...
        <div class="box-container">
         ...
         ?>
            ...
            echo '<p class="empty">Tidak ada video! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Tambah video</a></p>';
         }
         ?>
