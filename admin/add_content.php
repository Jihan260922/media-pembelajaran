...
if(isset($_POST['submit'])){
   ...
   if($verify_content-> rowCount() > 0){
      $message[] = 'Konten sudah dibuat!';
   }else{
      $add_content = $conn->prepare("INSERT INTO `content`(id, tutor_id, playlist_id, title, description, video, thumb, status, class) VALUES(?,?,?,?,?,?,?,?,?)");
      $add_content->execute([$id, $tutor_id, $playlist_id, $title, $description, $rename_video, $rename_thumb, $status, $class]);
      move_uploaded_file($thumb_tmp_name, $thumb_folder);
      move_uploaded_file($video_tmp_name, $video_folder);
      $message[] = 'Konten baru berhasil dibuat!';
   }
}
...
<body>
    ...
    <section class="video-form">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <p>Perintah video<span>*</span></p>
            <textarea name="description" class="box" required placeholder="masukan perintah" maxlength="1000" cols="30"
                rows="10"></textarea>
