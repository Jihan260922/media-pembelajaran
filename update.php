    ...
    <section class="form-container" style="min-height: calc(100vh - 19rem);">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="flex">
                ...
                <div class="col">
                    <p>Password lama</p>
                    <input type="password" name="old_pass" placeholder="Masukan password lama" maxlength="50"
                        class="box">
                    <p>Password baru</p>
                    <input type="password" name="new_pass" placeholder="Masukan password baru" maxlength="50"
                        class="box">
                    <p>Konfirmasi password</p>
                    <input type="password" name="cpass" placeholder="Konfirmasi password baru" maxlength="50"
                        class="box">
                </div>
            </div>
